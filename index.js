...
async function loadPartial(placeholderId,fileName){const ph=document.getElementById(placeholderId);if(!ph)return;const cands=[prefix(`PARTIALS/${fileName}`),isGh&&repoBase?`${repoBase}/expiriti-r19-preview-20260826/PARTIALS/${fileName}`:null,!isGh?`${depth}PARTIALS/${fileName}`:null,"/expiriti-r19-preview-20260826/PARTIALS/"+fileName].filter(Boolean);let html="",lastErr=null;for(const u of cands)try{const url=u+(u.includes("?")?"&":"?")+"v=ghassets-20260826T101020Z";const resp=await fetch(url,{cache:DEBUG_NOCACHE?"reload":"force-cache"});if(!resp.ok)throw new Error("HTTP "+resp.status+" "+resp.statusText);html=await resp.text();break}catch(e){lastErr=e}if(!html){console.warn("[Expiriti] No se pudo cargar partial:",fileName,lastErr);return}const template=document.createElement("template");template.innerHTML=html;ph.replaceWith(template.content)}
...
function bindHeroGallerySwipe(){const track=Q("#heroGalleryCarousel .carousel-track");if(!track||track.__r18SwipeBound)return;track.__r18SwipeBound=1;track.style.touchAction="pan-y";let active=false,x0=0,y0=0,left0=0,axis=0,id=null;on(track,"pointerdown",e=>{if(e.isPrimary===false)return;active=true;axis=0;id=e.pointerId;x0=e.clientX;y0=e.clientY;left0=track.scrollLeft},{passive:true});on(track,"pointermove",e=>{if(!active||e.pointerId!==id)return;const dx=e.clientX-x0,dy=e.clientY-y0;if(!axis){if(Math.abs(dx)<10&&Math.abs(dy)<10)return;axis=Math.abs(dx)>Math.abs(dy)*1.15?1:-1}if(axis===1){e.preventDefault();const max=Math.max(0,track.scrollWidth-track.clientWidth);track.scrollLeft=Math.max(0,Math.min(max,left0-dx))}},{passive:false});const end=e=>{if(e.pointerId!==id)return;active=false;axis=0;id=null};on(track,"pointerup",end,{passive:true});on(track,"pointercancel",end,{passive:true})}
...
/* 8) HERO gallery data */
const HERO_GALLERY_DATA={contable:{label:"Contables",defaultSys:"nominas",systems:{contabilidad:{label:"Contabilidad",icon:"/expiriti-r19-preview-20260826/IMG/logos/contabilidad-hz-384.webp",images:[{src:"IMG/contamate.webp"},{src:"IMG/contadesglo.webp"},{src:"IMG/conta%20y%20bancos.webp"},{src:"IMG/conta%20y%20bancos%202.webp"},{src:"IMG/impuestos%20sin%20estres%20conta%20y%20bancos.webp"},{src:"IMG/1conta.webp"}]},nominas:{label:"Nóminas",icon:"/expiriti-r19-preview-20260826/IMG/logos/nominas-hz-384.webp",images:[{src:"IMG/primera.webp"},{src:"IMG/nomisr.webp"},{src:"IMG/490962328_1082897360538668_175183934644162321_n.webp"},
{src:"/expiriti-r19-preview-20260826/IMG/logos/nominas-hz-384.webp",logo:"nominas"}
,{src:"IMG/ptu.webp"},{src:"IMG/posible.webp"}]},bancos:{label:"Bancos",icon:"/expiriti-r19-preview-20260826/IMG/logos/bancos-hz-384.webp",images:[{src:"IMG/efectivamente.webp"},{src:"IMG/olvida.webp"},{src:"IMG/CONTROL%20MOVIMIENTOS%20BANCARIOS.webp"},{src:"IMG/CARRUSEL%20CONECTA%201jpg.webp"},{src:"IMG/CARRUSEL%20CONECTA%202.webp"},{src:"IMG/PAGARAN.webp"}]},xml:{label:"XML en Línea+",icon:"/expiriti-r19-preview-20260826/IMG/logos/xml-hz-384.webp",images:[{src:"IMG/dos.webp"},{src:"IMG/SOFTWARE%20FAVORITO%201.webp"},{src:"IMG/SOFTWARE%20FAVORITO%202.webp"}]}}},comercial:{label:"Comerciales",defaultSys:"pro",systems:{pro:{label:"Comercial Pro",icon:"/expiriti-r19-preview-20260826/IMG/logos/comercial-pro-hz-384.webp",images:[{src:"IMG/captura%20manual.webp"},{src:"IMG/procumple.webp"},{src:"IMG/prorenta.webp"},{src:"IMG/COMPRAVENTA.webp"},{src:"IMG/FUNCIONES%20PRO.webp"},{src:"IMG/FUNCIONES%20PRO2.webp"}]},premium:{label:"Comercial Premium",icon:"/expiriti-r19-preview-20260826/IMG/logos/comercial-premium-hz-384.webp",images:[{src:"IMG/desde%20compras%20ventas%20traslados.webp"},{src:"IMG/INVENTARIO%20Y%20VENTAS.webp"},{src:"IMG/LIGAS%20DE%20PAGO.webp"},{src:"IMG/NOTAS%20DE%20VENTA.webp"},{src:"IMG/COSTOS%20Y%20UTILIDADES.webp"},{src:"IMG/INVENTARIOS,%20FINANZAS%20jpg.webp"}]},factura:{label:"Factura electrónica",icon:"/expiriti-r19-preview-20260826/IMG/logos/factura-hz-384.webp",images:[{src:"IMG/INCLUYE%201.webp"},{src:"IMG/INCLUYE%202.webp"},{src:"IMG/INCLUYE%203.webp"},{src:"IMG/CARACTERISTICAS%202.webp"},{src:"IMG/CARACTERISTICAS%203.webp"},{src:"IMG/carta%20porte.webp"}]}}},nube:{label:"En la Nube",defaultSys:"contabiliza",systems:{contabiliza:{label:"Contabiliza",icon:"/expiriti-r19-preview-20260826/IMG/logos/contabilidad-nube-hz-384.webp",images:[{src:"IMG/contatranq.webp"},{src:"IMG/contaclari.webp"},{src:"IMG/contabprocesos.webp"},{src:"IMG/contabireal.webp"}]},personia:{label:"Personia",icon:"/expiriti-r19-preview-20260826/IMG/logos/nominas-nube-hz-384.webp",images:[{src:"IMG/personiasbc.webp"},{src:"IMG/persoseg.webp"},{src:"IMG/personmas.webp"},{src:"IMG/personiaptu.webp"},{src:"IMG/persobime.webp"}]},vende:{label:"Vende",icon:"/expiriti-r19-preview-20260826/IMG/logos/vende-hz-384.webp",images:[{src:"IMG/vendevendes.webp"},{src:"IMG/vendesigue.webp"},{src:"IMG/vendexml.webp"},{src:"IMG/vendesegui.webp"},{src:"IMG/venderuta.webp"},{src:"IMG/vendequien.webp"}]},colabora:{label:"Colabora",icon:"/expiriti-r19-preview-20260826/IMG/colabora.webp",images:[{src:"IMG/colabacceso.webp"},{src:"IMG/colabtoda.webp"},{src:"IMG/colacentra.webp"},{src:"IMG/colacola.webp"}]}}},productividad:{label:"Productividad",defaultSys:"analiza",systems:{analiza:{label:"Analiza",icon:"IMG/analiza.webp",images:[{src:"IMG/analizareportes.webp"},{src:"IMG/anadecide.webp"},{src:"IMG/ananocuadr.webp"},{src:"IMG/analizarespues.webp"},{src:"IMG/analizadescuadr.webp"},{src:"IMG/analizacorrige.webp"},{src:"IMG/analizacfdi.webp"}]},evalua:{label:"Evalúa",icon:"/expiriti-r19-preview-20260826/IMG/logos/evalua-hz-384.webp",images:[{src:"IMG/evaluaencu.webp"},{src:"IMG/evaluabien.webp"},{src:"IMG/nom37.webp"}]},optimiza:{label:"Optimiza",icon:"/expiriti-r19-preview-20260826/IMG/logos/optimiza-hz-384.webp",images:[{src:"/expiriti-r19-preview-20260826/IMG/logos/optimiza-hz-384.webp",logo:"optimiza"}]},anticipa:{label:"Anticipa",icon:"/expiriti-r19-preview-20260826/IMG/logos/anticipa-hz-384.webp",images:[{src:"/expiriti-r19-preview-20260826/IMG/logos/anticipa-hz-384.webp",logo:"anticipa"}]}}},servicios:{label:"Servicios",defaultSys:"polizas",systems:{}}};
...
function r19ResponsiveLogo(img,src,sizes){if(/\/(?:colabora|analiza)\.webp$/.test(String(src||""))){const name=String(src).match(/([^/]+)\.webp$/)[1];img.srcset=`/expiriti-r19-preview-20260826/IMG/${name}.webp 600w`;img.sizes=sizes;img.width=600;img.height=210;img.dataset.r19Logo=name+"-hz-legacy";return}const m=String(src||"").match(/\/IMG\/logos\/(.+)-(nsq|hz)-(160|384)\.webp$/);if(!m)return;const [,name,kind]=m;let candidates="";if(kind==="nsq")candidates=`/expiriti-r19-preview-20260826/IMG/logos/${name}-nsq-160.webp 160w, /expiriti-r19-preview-20260826/IMG/logos/${name}-nsq-320.webp 320w`;else{const top=name==="comercial-start"?740:name==="comercial-pro"?738:768;candidates=`/expiriti-r19-preview-20260826/IMG/logos/${name}-hz-384.webp 384w, /expiriti-r19-preview-20260826/IMG/logos/${name}-hz-${top}.webp ${top}w`;if(name==="nominas")candidates+=", /expiriti-r19-preview-20260826/IMG/logos/nominas-hz-1440.webp 1440w"}img.srcset=candidates;img.sizes=sizes;img.dataset.r19Logo=name+"-"+kind;if(kind==="nsq"){img.width=160;img.height=160}else{const dims={"anticipa":[384,131],"bancos":[384,136],"comercial-premium":[384,129],"comercial-pro":[384,130],"comercial-start":[384,130],"contabilidad":[384,112],"contabilidad-nube":[384,97],"evalua":[384,146],"factura":[384,123],"nominas":[384,129],"nominas-nube":[384,101],"optimiza":[384,126],"vende":[384,147],"xml":[384,83]}[name]||[384,160];img.width=dims[0];img.height=dims[1]}}
...
function initPromoLightbox(){
  ...
  on(imageWrap,"pointerdown",event=>{if(event.button!==0)return;pointer={id:event.pointerId,x:event.clientX,y:event.clientY,startX:event.clientX,startY:event.clientY,panX,panY};imageWrap.setPointerCapture(event.pointerId);imageWrap.classList.add("is-dragging")});
  on(imageWrap,"pointermove",event=>{if(!pointer||event.pointerId!==pointer.id)return;const dx=event.clientX-pointer.x,dy=event.clientY-pointer.y;if(zoom>1){panX=pointer.panX+dx;panY=pointer.panY+dy;paint()}});
  const endPointer=event=>{if(!pointer||event.pointerId!==pointer.id)return;const dx=event.clientX-pointer.startX,dy=event.clientY-pointer.startY;if(zoom===1&&group.length>1&&Math.abs(dx)>50&&Math.abs(dx)>Math.abs(dy))move(dx<0?1:-1);pointer=null;imageWrap.classList.remove("is-dragging")};
  on(imageWrap,"pointerup",endPointer);on(imageWrap,"pointercancel",endPointer);on(window,"resize",paint);
...
/* 12) INIT principal */
on(window,"DOMContentLoaded",async()=>{await Promise.all([loadPartial("header-placeholder","global-header.html"),loadPartial("footer-placeholder","global-footer.html")]);normalizeRoutes(document);bindWheelOnTabs();initForms();initTabsProductos();initPromosFilter();initClickableCards();initTOC();initFooterObserver();initHeroGallery();bindHeroGallerySwipe();["contable","comercial","nube","productividad","servicios"].forEach(initReelsCarousel);hydrateVisibleReelPosters();initReelsTabs();initYTLiteVideos();initFAQ();initPromoLightbox();initServicesPager();const yearSpan=document.getElementById("gf-year");yearSpan&&(yearSpan.textContent=new Date().getFullYear())});
...
/* R18_FINAL_POLISH_3_HERO_SWIPE_LATE_OWNER */
(()=>{const bind=()=>{const track=document.querySelector("#heroGalleryCarousel .carousel-track");if(!track||track.__r18LateSwipeBound)return;track.__r18LateSwipeBound=1;track.style.setProperty("touch-action","pan-y","important");let active=false,id=null,x0=0,y0=0,left0=0,axis=0;track.addEventListener("pointerdown",e=>{if(e.isPrimary===false)return;active=true;id=e.pointerId;x0=e.clientX;y0=e.clientY;left0=track.scrollLeft;axis=0},{passive:true});track.addEventListener("pointermove",e=>{if(!active||e.pointerId!==id)return;const dx=e.clientX-x0,dy=e.clientY-y0;if(!axis){if(Math.abs(dx)<10&&Math.abs(dy)<10)return;axis=Math.abs(dx)>Math.abs(dy)*1.15?1:-1}if(axis===1){e.preventDefault();const max=Math.max(0,track.scrollWidth-track.clientWidth);track.scrollLeft=Math.max(0,Math.min(max,left0-dx))}},{passive:false});const end=e=>{if(e.pointerId!==id)return;active=false;id=null;axis=0};track.addEventListener("pointerup",end,{passive:true});track.addEventListener("pointercancel",end,{passive:true})};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>setTimeout(bind,0),{once:true}):setTimeout(bind,0)})();
